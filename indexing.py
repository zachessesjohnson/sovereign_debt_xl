...
@xl_func("float value, float[] values: float", name="SOV_RANK_PCT")
...
@xl_func("float[] values: float[]", name="SOV_ZSCORE")
...
@xl_func("float[] values: float[]", name="SOV_NORMALIZE_MINMAX")
...
@xl_func("float[] values, int base_period: float[]", name="SOV_INDEX_TO_BASE")
