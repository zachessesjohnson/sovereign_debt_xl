...
@xl_func("float[] values, float[] weights: float", name="SOV_WEIGHTED_AVERAGE")
...
@xl_func("float[] values, int window: float[]", name="SOV_ROLLING_AVERAGE")
...
@xl_func("float[] values, float trim_pct: float", name="SOV_TRIMMED_MEAN")
...
@xl_func("float[] values: object[][]", name="SOV_DESCRIBE")
