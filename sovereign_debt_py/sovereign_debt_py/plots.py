"""Plotting functions for sovereign debt analysis.

Renders Matplotlib charts to PNG bytes.

Example usage
-------------
>>> png_bytes = sdxl_plot_yield_curve([1, 2, 5, 10], [0.02, 0.025, 0.03, 0.035])
>>> with open("curve.png", "wb") as f:
...     f.write(png_bytes)
"""
...
def _png_to_xl_image(png_bytes: bytes) -> bytes:
    """Return PNG image bytes directly."""
    return png_bytes
